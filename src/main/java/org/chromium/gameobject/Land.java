...
public class Land {
	...
	public Land(int width, MainCharacter mainCharacter) {
		...
		land1 = Resource.getResouceImage("res/gui/screens/dino/land1.png");
		land2 = Resource.getResouceImage("res/gui/screens/dino/land2.png");
		land3 = Resource.getResouceImage("res/gui/screens/dino/land3.png");
		int numberOfImageLand = width / land1.getWidth() + 2;
		listLand = Collections.synchronizedList(new ArrayList<ImageLand>());
		synchronized (listLand){
